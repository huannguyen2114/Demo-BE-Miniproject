...
export default async function login(req, res) {
    try {
        ...
        extractedUser = extractedUser.toJSON(); // Convert Sequelize instance to a plain JavaScript object
        extractedUser.accessToken = accessToken;
        extractedUser.refreshToken = refreshToken;

        // Send the modified extractedUser instance as a response
        res.status(200).json(extractedUser);
